<template>
      ...
      <button target="_blank" @click="openWhatsApp" class="whatsapp-button">
...
<script setup>
const openWhatsApp = () => {
  const phoneNumber = '0671635736';  // Replace with your WhatsApp phone number (in international format without +)
  const message = 'Hello! I need some help.';  // Pre-filled message (optional)
